...
exports.ChangePasswordFunc = void 0;
...
exports.ChangePasswordFunc = async ({ parent, info, args, context: { req } }, stack) => {
    try {
        ...
        const { error, data } = await refreshToken_1.refreshToken(user.refreshToken, "SELLER");
        if (!data) {
            throw error;
        }
        return {
...
const resolvers = {
    Mutation: {
        ChangePassword: resolverFuncWrapper_1.defaultResolver(resolverFuncWrapper_1.privateResolver(exports.ChangePasswordFunc))
    }
};
exports.default = resolvers;
//# sourceMappingURL=ChangePassword.resolvers.js.map